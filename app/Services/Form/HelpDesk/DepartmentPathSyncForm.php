...
use WA\Services\Queues\HelpDesk\DepartmentPathSync;
use WA\DataLoader\HelpDesk\Loader\DepartmentPathLoader;

/**
 * Class DepartmentPathSyncForm.
 */
class DepartmentPathSyncForm extends AbstractForm
{
    /**
     * @var Loader
     */
    ...
    protected $queueRunner = 'WA\Services\Queues\HelpDesk\DepartmentPathSync';

    /**
     * DepartmentPathSyncForm constructor.
     *s
     * @param DepartmentPathLoader $loader
     * @param QueueManager $queue
     * @param SyncJobInterface $sync
     */
    public function __construct(DepartmentPathLoader $loader, QueueManager $queue, SyncJobInterface $sync)
    {
        $this->loader = $loader;
        $this->queue = $queue;
        $this->sync = $sync;
