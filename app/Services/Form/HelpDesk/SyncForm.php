 ...
 * Class SyncForm.
 */
class SyncForm extends AbstractForm
{
    /**
     * @var Loader
     */
    ...
    protected $queueRunner = 'WA\Services\Queues\HelpDesk\AssetDeviceSync';
     ...
     */
    public function __construct(Loader $loader, QueueManager $queue, SyncJobInterface $sync)
    {
        $this->loader = $loader;
        $this->queue = $queue;
        $this->sync = $sync;
