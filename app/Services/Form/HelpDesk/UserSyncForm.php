 ...
 * Class SyncForm.
 */
class UserSyncForm extends AbstractForm
{
    /**
     * @var Loader
     */
    ...
    protected $queueRunner = 'WA\Services\Queues\HelpDesk\UserSync';

    /**
     * UserSyncForm constructor.
     *s
     * @param UserLoader $loader
     * @param QueueManager $queue
     * @param SyncJobInterface $sync
     */
    public function __construct(UserLoader $loader, QueueManager $queue, SyncJobInterface $sync)
    {
        $this->loader = $loader;
        $this->queue = $queue;
        $this->sync = $sync;
