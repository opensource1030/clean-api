 ...
 * @license MIT
 */
class ConfideEmployeeValidator
{
    /**
     ...
     */
    public function validate(ConfideEmployeeInterface $user, $ruleset = 'create')
    {
     ...
     *
     * @param ConfideEmployeeInterface $user
     *
     * @return bool True if password is valid.
     */
    public function validatePassword(ConfideEmployeeInterface $user)
    {
        $hash = App::make('hash');
     ...
     */
    public function validateIsUnique(ConfideEmployeeInterface $user)
    {
        $identity = [
            'email' => $user->email,
     ...
     */
    public function validateAttributes(ConfideEmployeeInterface $user, $ruleset = 'create')
    {
     ...
     */
    public function attachErrorMsg(ConfideEmployeeInterface $user, $errorMsg, $key = 'confide')
    {
