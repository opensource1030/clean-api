 ...
 *
 * @notes overrides the default implementation in Laravel, makes this pagination compatible with ZURB Foundation
 *
 * @see usage in views/_partials/pagination (and of course in config/view)
 */
class FoundationPresenter
{
    /**
    ...
    /**
     * Create a new ZURB Foundation presenter instance.
     *
    ...
    /**
     * Render the Foundation pagination contents.
     *
     * @return string
     */
    ...
    {
        return '<li class="unavailable">&hellip;</li>';
    }
