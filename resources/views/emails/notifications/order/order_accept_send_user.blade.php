...
<container>
  ...
  <spacer size="25"></spacer>
  <center>
    <img src="./../assets/img/animat-checkmark-color.gif" alt="Accepted" height="200" width="200"/>
  </center>
  <row>
    <columns large="1">&nbsp;</columns>
    <columns large="10" >
      <h3 class="text-center">Your Order has been Accepted and is pending to be Processed</h3>
  ...
  <row>
    <columns> <center><button href="#" class="large dark">View Details</button> </center></columns>
  </row>
  <hr>
  <spacer size="16"></spacer>
  <row class="footer text-center">
    ...
    <columns large="6">
      <p>
        ...
        <strong>Email:</strong> <a href="mailto:support@email.com"> support@email.com</a> <br/>
        230 North St.
        Danvers, MA, 01923 <br/>
        USA<br/>
      </p>
