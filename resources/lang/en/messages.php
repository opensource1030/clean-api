...
return [
    'NotExistInclude' => 'One or More Includes selected don\'t exist',
    'InvalidJson' => 'JSON is Invalid',
    'NotExistClass' => 'the :class selected doesn\'t exists',
    ...
    'FilterErrorNotUser' => 'The requested endpoint has not any results.'
];