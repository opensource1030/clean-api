...
class CompanySaml2TableSeeder extends BaseTableSeeder
{
    ...
    public function run()
    {
        ...
        $dataSimpleSamlPhp = [
            'entityId' => 'http://simplesamlphp.local/simplesaml/saml2/idp/metadata.php',
            'singleSignOnServiceUrl' => 'http://simplesamlphp.local/simplesaml/saml2/idp/SSOService.php',
            'singleSignOnServiceBinding' => 'urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Redirect',
            'singleLogoutServiceUrl' => 'http://simplesamlphp.local/simplesaml/saml2/idp/SingleLogoutService.php',
            'singleLogoutServiceBinding' => 'urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Redirect',
