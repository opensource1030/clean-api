...
/*
scope:get_allocations
scope:get_allocation
...
scope:get_categoryapps
scope:get_categoryapp
scope:create_categoryapp
scope:update_categoryapp
scope:delete_categoryapp

scope:get_conditionsfields
scope:get_conditionsfield
scope:create_conditionsfield
scope:update_conditionsfield
scope:delete_conditionsfield

scope:get_conditionsoperators
scope:get_conditionsoperator
scope:create_conditionsoperator
scope:update_conditionsoperator
scope:delete_conditionsoperator
