...
{ 
    ...
    {
        // Route information
        $config['sp']['entityId'] = 'http://clean.api/saml2/metadata';

        $config['sp']['assertionConsumerService']['url'] = 'http://clean.api/saml2/acs';

        $config['sp']['singleLogoutService']['url'] = 'http://clean.api/saml2/sls';
        ...
        $return = $Saml2Auth->login($returnTo, array(), false, false, true /* stay! */);
